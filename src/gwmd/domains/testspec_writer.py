...
from gwmd.domains.model import DEFAULT_MAPPING, MappingConfig, TestSpec
...
def assignments(spec: TestSpec, mapping: Optional[MappingConfig] = None) -> list[tuple[str, object]]:
